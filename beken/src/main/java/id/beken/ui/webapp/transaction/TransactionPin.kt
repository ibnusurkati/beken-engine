...
class TransactionPin: AppCompatEditText {

    private var mSpace = 1f //24 dp by default, space between the lines
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        textEmptyPaint?.color = ContextCompat.getColor(context, R.color.primary_color)
    ...
    private fun updateColorForLines(next: Boolean) {
        if (isFocused) {
            ...
            mLinesPaint?.color = ContextCompat.getColor(context, R.color.primary_color)
            if (next) {
                mLinesPaint?.color = ContextCompat.getColor(context, R.color.primary_color)
            }
        } else {
